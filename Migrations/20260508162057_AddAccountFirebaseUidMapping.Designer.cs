...
namespace PharmacyPOS.Migrations
{
    ...
    [Migration("20260508162057_AddAccountFirebaseUidMapping")]
    partial class AddAccountFirebaseUidMapping
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PharmacyPOS.Models.PharmacyOrder", b =>
                {
                    ...
                    b.Property<int>("EstimatedDeliveryMaxMinutes")
                        .HasColumnType("int");

                    b.Property<int>("EstimatedDeliveryMinMinutes")
                        .HasColumnType("int");

                    b.Property<string>("FulfillmentBranch")
                        .IsRequired()
                        .HasMaxLength(160)
                    ...
                    b.Property<string>("PrescriptionFilesJson")
                        .IsRequired()
                        .HasMaxLength(4000)
